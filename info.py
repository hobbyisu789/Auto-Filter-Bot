...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001554312623") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://auto-filter-bot-h84f.onrender.com") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
